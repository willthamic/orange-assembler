...
TX:	nop
	...
	andi r7, r6, 0x000F ; Copy first byte into scratch register
	la r26, TX0         ; Update loop address
TX0:	ld r4, 0xFFE0       ; Read TX_BUSY into r4
	brnz r26, r4        ; Branch up if TX_BUSY = 1
	st r7, 0xFFE4       ; Store r7 to TX_DATA

	andi r7, r6, 0x00F0 ; Copy second byte into scratch register
...
TX1:	ld r4, 0xFFE0       ; Read TX_BUSY into r4
	...
	andi r7, r6, 0x0F00 ; Copy third byte into scratch register
...
TX2:	ld r4, 0xFFE0       ; Read TX_BUSY into r4
	...
	andi r7, r6, 0xF000 ; Copy fourth byte into scratch register
